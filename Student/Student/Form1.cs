...
namespace Student
{
    public partial class FormStudent : Form
    {
        ...
        private void numericUpDownEkz4_ValueChanged(object sender, EventArgs e)
        {
            ...
            textBoxStudentInfo.Text = student1.ToString(); //вывести на экранOzenki
        }
        ...
        private void comboBoxSemestr_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else //иначе - экзамен был
            {
                ...
                else
                {
                    ...
                    //вывести оценку
                    numericUpDownEkz1.Value = student1.Ozenki[comboBoxSemestr.SelectedIndex+1, 1];
                };
            };
            //если не было экзамена
            ...
            else //иначе - экзамен был
            {
                ...
                else
                {
                    ...
                    //вывести оценку
                    numericUpDownEkz2.Value = student1.Ozenki[comboBoxSemestr.SelectedIndex+1, 2];
                };
            };
            //если не было экзамена
            ...
            //если не было экзамена
            if (student1.Ozenki[comboBoxSemestr.SelectedIndex+1, 5] == 0)
            {
            ...
            else //иначе - экзамен был
            {
                ...
                //если неявка
                if (student1.Ozenki[comboBoxSemestr.SelectedIndex+1, 5] == 1)
                {
        ...
        //ЭКЗАМЕН 2
        private void checkBoxEkz2_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void checkBoxEkz2neyavka_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        //ЭКЗАМЕН 3
        private void checkBoxEkz3_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void checkBoxEkz3neyavka_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        //ЭКЗАМЕН 4
        private void checkBoxEkz4_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void checkBoxEkz4neyavka_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        //ЭКЗАМЕН 5
        private void checkBoxEkz5_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void checkBoxEkz5neyavka_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        //private void FormStudent_Load(object sender, EventArgs e)   строка 445
        ...
        private void buttonOplatit_Click(object sender, EventArgs e)
        {
            ...
            if (student1 is StudentPlat)
            {
                ...
                (student1 as StudentPlat).OplatitObuchenie(numericUpDownSum.Value);
                textBoxStudentInfo.Text = student1.ToString(); //вывести на экран
            }
        }
